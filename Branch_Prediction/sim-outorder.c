...
"  Predictor `comb' combines a bimodal and a 2-level predictor.\n"
  ...
  opt_reg_string(odb, "-bpred",
		 "branch predictor type {nottaken|taken|perfect|bimod|2lev|comb|tournament|ogehl}",
  ...
  //////////////////////////////////////////////////////////////////
    /*
    tournament and ogehl predictor
    */
  //////////////////////////////////////////////////////////////////               
  ...
  opt_reg_int_list(odb, "-bpred:ogehl",
                   "OGEHL predictor config "
		   "(<>)",
                   NULL, 0, &tour_nelt,
		   /* default */NULL,
                   /* print */TRUE, /* format */NULL, /* !accrue */FALSE);
		  ...
		  int argc, char **argv)        /* command line arguments */
{
  ...
  //////////////////////////////////////////////////////////////////
    ...
    pred = bpred_create(BPredTournament,
			  /* bimod table size */ 0,
			  /* local history size */1024,
			  /* global history size */4096,
			  /* meta table size */0,
			  /* ghr size */12,
			  /* history xor address */0,
			  /* btb sets */btb_config[0],
